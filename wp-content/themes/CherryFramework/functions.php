...
//------------------------------------------------------
	...
	**/
    ...
    function getOGTags($s){
        $html = '';
        /*$html = $html .  '<meta property="og:locale" content="ru_RU" />';
        $html = $html .  '<meta property="og:type" content="website" />';
        $title = getTitle($s);
        $html = $html .  '<meta property="og:title" content="'.$title.'" />';
        $html = $html .  '<meta property="og:description" content="" />';
        $path = $_SERVER['REQUEST_URI'];
        $url  = 'http://u-travell.ru'.$path;
        $html = $html .  '<meta property="og:url" content="'.$url.'" />';
        $html = $html .  '<meta property="og:site_name" content="u-travell" />';*/
        $html = $html .  '<meta property="og:image" content="http://u-travell.ru/wp-content/themes/theme51349/images/logo.png" />';
